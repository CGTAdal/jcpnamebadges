<div class="order-new clb" id="enter_names">
	...
	<h3 class="title">Enter Name: (<?php echo $description;?>) $2.75</h3>
	<div id="input_boxes">
		<div class="order-box clb input_box" value="1">
			...
			<div style="padding-left:15px;">
				...
				<label>
					...
					<input type="text" class="license license-optical" value="" name="license_1" style="width:150px" onkeypress="return isNumber(event)" />
