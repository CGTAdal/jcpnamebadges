...
<div style="min-height: 300px; padding-bottom:20px" class="portlet x12">
	...
	<div class="portlet-content">
			...
			<?php if(count($orders)>0) {?>
				<?php $i=0;foreach($orders as $order) {?>
					<tr>
						...
						<td>
							<?php echo HANDLING_CHARGE_PER_ORDER; ?>
						</td>		
						<td>
						...
						<td align="right">
							<?php 
							echo number_format(number_format($order->order_total*BADGES_NET_PRICE + $totalserice*CHARMS_NET_PRICE + $order->order_extender_qty*ACCESSORIES_EXT_NET_PRICE + $order->order_bar_qty*ACCESSORIES_BAR_NET_PRICE + $order->order_mf_qty*EXTRA_MAGNETS_NET_PRICE + $order->order_pf_qty*EXTRA_PINS_NET_PRICE, 2)+3.00,2);?>
						</td>
						<td>
		...
		<div style="float:right">
			...
			<select class="select_perpage_list_order">
				<option value="1" <?php echo ($select_perpage==1)?'selected':'';?>>1</option>
