<div style="min-height: 300px;" class="portlet x12">
	<div class="portlet-header"><h4>Add a new Store</h4></div>			
		<div class="portlet-content" >		
			<form class="form label-inline" id="form_store_add" method="post" action="<?php echo base_url();?>admin/store/add">
				...
				<div class="field">
					...
					<input type="text" class="medium" size="50" name="fname" id="store_location_name" value="<?php echo (isset($tore->store_location_name))?$store->store_location_name:"";?>">
				</div>				
				<div class="field">
...
$(document).ready(function(){
	...
	$('.btn').click(function(){
		...
		$('#form_store_add').append(input_store_minor);
		$('#form_store_add').append(input_store_express);
		$('#form_store_add').append(input_store_ground);
		$('#form_store_add').append(input_store_location);
		$('#form_store_add').append(input_store_number);
		$('#form_store_add').append(input_store_location_name);
		$('#form_store_add').append(input_store_address_2);
		$('#form_store_add').append(input_store_address);
		$('#form_store_add').append(input_store_city);
		$('#form_store_add').append(input_store_state);
		$('#form_store_add').append(input_store_zip);
		$('#form_store_add').append(input_store_contact);
		$('#form_store_add').append(input_store_phone);
		$('#form_store_add').append(input_store_email);
		$('#form_store_add').append(input_store_svg);
		$('#form_store_add').append(input_store_aor);		
		$('#form_store_add').submit();		
	});	
});
